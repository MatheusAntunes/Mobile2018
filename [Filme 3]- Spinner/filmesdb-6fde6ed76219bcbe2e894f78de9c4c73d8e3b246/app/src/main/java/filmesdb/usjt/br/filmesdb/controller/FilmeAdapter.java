...
public class FilmeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(linhaLista == null) {
            ...
            ImageView fotoGenero = linhaLista.findViewById(R.id.foto_genero_filme);

            TextView linhaTitulo = linhaLista.findViewById(R.id.linha_titulo_filme);

            TextView linhaDiretor = linhaLista.findViewById(R.id.linha_diretor_filme);
